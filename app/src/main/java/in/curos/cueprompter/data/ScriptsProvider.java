...
public class ScriptsProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = CuePrompterContract.AUTHORITY;
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case SCRIPTS:
                return ContentResolver.CURSOR_DIR_BASE_TYPE+"/cueprompter-scripts";
            case SCRIPT:
                return ContentResolver.CURSOR_ITEM_BASE_TYPE+"/cueprompter-script";
